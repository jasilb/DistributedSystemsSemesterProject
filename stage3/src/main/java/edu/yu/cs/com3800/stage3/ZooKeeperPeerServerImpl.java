            ...
            while (!this.shutdown){
                switch (getPeerState()){
                    ...
                    case LEADING:
                        ...
                        roundRobinLeader = new RoundRobinLeader(outgoingMessages,incomingMessages,this, list  );
                        //start thread
                    ...
                    case FOLLOWING:
                        //make thread
                        javaRunnerFollower = new JavaRunnerFollower(outgoingMessages,incomingMessages,this);
                        //start thread
