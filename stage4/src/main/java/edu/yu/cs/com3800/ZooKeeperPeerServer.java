...
public interface ZooKeeperPeerServer extends LoggingServer {
    ...
    void setCurrentLeader(edu.yu.cs.com3800.Vote v) throws IOException;

    edu.yu.cs.com3800.Vote getCurrentLeader();

    void sendMessage(edu.yu.cs.com3800.Message.MessageType type, byte[] messageContents, InetSocketAddress target) throws IllegalArgumentException;

    void sendBroadcast(edu.yu.cs.com3800.Message.MessageType type, byte[] messageContents);
