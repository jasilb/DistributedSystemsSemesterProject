...
public class Message {
    ...
    /**
     * create a edu.yu.cs.com3800.Message object from the network payload bytes
     *
    ...
    public String toString(){
        if(this.stringRepresentation == null){
            ...
            builder.append("edu.yu.cs.com3800.Message Type: ");
            ...
            builder.append("\nedu.yu.cs.com3800.Message Contents: \n");
