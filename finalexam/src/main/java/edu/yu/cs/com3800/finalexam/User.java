...
public class User implements Comparable<User>{
    ...
    /**
     * Store all given info, and determine which resource is the user's dominant resource
     * @param userID
     * @param requiredResourcesPerTask the resources this user needs to do a unit of work
     ...
     * @throws IllegalStateException if the user requires resources that don't exist at all in the system
     */
    public User(String userID, Map<String,Resource> requiredResourcesPerTask, Map<String,SystemResource> totalResourcesInSystem){
     ...
     * @param allocation
     * @throws IllegalArgumentException if allocation does not include a sufficient amount of all the resources this user requires to do a unit of work
     */
    public void allocateResources(Collection<Resource> allocation){
        if(!allocation.containsAll(this.requiredResourcesPerTask.values())){
            throw new IllegalArgumentException("The given allocation does not include all the resources required by this user");
        }
    ...
    /**
     * update my dominant share since I was allocated the given additional amount of my dominant resource
    ...
    /**
     * A user's dominant share is the fraction of the total existing amount of his dominant resource he has already been allocated
