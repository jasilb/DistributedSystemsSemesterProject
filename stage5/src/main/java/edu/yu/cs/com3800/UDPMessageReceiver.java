...
public class UDPMessageReceiver extends Thread implements LoggingServer {
    ...
    LinkedBlockingQueue<Message> gossip;

    public UDPMessageReceiver(LinkedBlockingQueue<Message> incomingMessages, InetSocketAddress myAddress, int myPort, ZooKeeperPeerServer peerServer, LinkedBlockingQueue<Message> gossip) throws IOException {
